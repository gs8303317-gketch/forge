...
- Player 1.26.0: lag-free seek preview (throttled keyframe scrub + EXACT settle); large scrub timecode HUD; thicker buffered scrubber; landscape bottom-tools spacing; HW decoder default; larger back-buffer for scrubbing
